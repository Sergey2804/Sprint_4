...
public class AnswersAndQuestionsTest extends BaseTest {

    // задаем переменные для параметров теста
    private static int index;
    private static String question;
    private static String answer;


    public AnswersAndQuestionsTest(int index, String question, String answer) {
        this.index = index;
    ...
    public void checkClickQuestion_expectTextIsDisplayed() {
        ...
        String actualQuestion = mainPage.clickOnQuestion(index);
